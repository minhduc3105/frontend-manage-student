    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-indigo-100 mt-1">
              Summary of your study activity
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          ...
          value={String(stats.classes_enrolled ?? 0)}
          icon={BookOpen}
        />
        <StatCard
          title="GPA"
          value={String(stats.gpa ?? 0)}
          icon={TrendingUpIcon}
        />
        <StatCard
          title="Study Points"
          value={String(stats.study_point ?? 0)}
          icon={AwardIcon}
        />
        <StatCard
          title="Discipline Points"
          value={String(stats.discipline_point ?? 0)}
          icon={AlertIcon}
        />
      </div>
        ...
        <div className="bg-background rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full text-left p-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors border border-blue-200 cursor-pointer"
            >
  ...
  return (
    <aside className="w-64 bg-background shadow-lg p-4 flex flex-col justify-between border-r border-gray-200">
      ...
      <div className="border-t border-gray-200 pt-4">
        <button
          onClick={onLogout}
          className="w-full text-left px-3 py-2 mt-2 flex items-center gap-3 text-red-500 hover:bg-red-50 rounded-lg transition-colors"
        >
    ...
    <button
      ...
      className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition-colors ${
        isActive
          ...
          : "text-foreground hover:bg-gray-50 hover:text-blue-600"
      }`}
    >
...
function AlertIcon(props: any) {
  return (
    ...
    >
      <path
        d="M10.29 3.86l-8.55 14.84A2 2 0 0 0 3.64 21h16.72a2 2 0 0 0 1.9-2.3L13.71 3.86a2 2 0 0 0-3.42 0z"
        strokeWidth="2"
      />
    </svg>
  );
