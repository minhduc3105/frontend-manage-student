    ...
    return (
        <ProtectedRoute>
            ...
            <div className="flex min-h-screen bg-background text-foreground relative">
                ...
                {/* SIDEBAR */}
                {/* 🎨 SỬA: bg-white -> bg-background, border-gray-200 -> border-border */}
                <div className="w-64 bg-background border-r border-border shadow-sm p-4 flex flex-col justify-between">
                    <div>
                        <div className="flex flex-col items-center mb-10">
                            {/* 🎨 SỬA: text-cyan-600 -> text-primary */}
                    ...
                    {/* ⚡ 3. THÊM FOOTER (Theme Toggle + Logout) */}
                    <div className="border-t border-border pt-4">
                        ...
                        {mounted && (
                            <button
                                ...
                                // 🎨 SỬA: hover:bg-muted
                                className="w-full text-left px-3 py-2 mb-1 flex items-center gap-3 hover:bg-muted rounded-lg transition-colors"
                            >
                                {resolvedTheme === 'dark' ? (
                        ...
                        <button
                            ...
                            // 🎨 SỬA: text-destructive, hover:bg-muted
                            className="w-full text-left px-3 py-2 mt-2 flex items-center gap-3 text-destructive hover:bg-muted rounded-lg transition-colors"
                        >
...
function SidebarLink({ id, activeSection, setSection, icon: Icon, text }: any) {
    ...
    return (
        <a
            ...
            className={`block px-3 py-2 rounded-lg transition-colors ${activeSection === id
