        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-indigo-100 mt-1">
              Summary of your family's study activity
            </p>
          </div>
        ...
        <div className="bg-background rounded-xl p-6 shadow-sm border border-gray-100 lg:col-span-2">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 border-b pb-3">
              ...
              <div>
                <div className="font-medium text-foreground">
                  Tuition overdue notice
                </div>
                <div className="text-sm text-muted-foreground">
                  September Invoice - 1 day ago
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-medium text-foreground">
                  New announcement from School
                </div>
                <div className="text-sm text-muted-foreground">
                  Holiday Schedule - Yesterday
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-200 pt-4 space-y-2">
        ...
        {mounted && (
          <button
            ...
            className="w-full text-left px-3 py-2 flex items-center gap-3 text-foreground hover:bg-muted rounded-lg transition-colors"
          >
            {resolvedTheme === "dark" ? (
        ...
        <button
          onClick={onLogout}
          className="w-full text-left px-3 py-2 flex items-center gap-3 text-red-500 hover:bg-red-50 rounded-lg transition-colors"
        >
